...
def update_text_references(root: Path, mappings):
    ...
    for text_file in text_files:
        ...
        for item in mappings:
            ...
            # Longer paths first, so folder references are replaced before bare filenames
